...
/*---------------------------------------------------------------------------------------------
testdata.js::EZ.toString.test() -- test scripts 
---------------------------------------------------------------------------------------------*/
//_____________________________________________________________________________________________
/*----------------------------------------------------------------------------------
----------------------------------------------------------------------------------*/
EZ.toString.test = function EZtoString_test()
{
	var arg, obj=null, ctx, ex, exfn, note = '';
	/*  jshint: future vars */	e = [arg, obj, ctx, ex, exfn, note];
	// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .

	function exfn(results, testrun)	//shows "." for spaces
	{
		testrun.results = testrun.results.replace(/ /g, '.')
	}
	var opts = {timestamp:false}


	//______________________________________________________________________________________	
	EZ.test.settings({group: 'issues found during use\n'});
EZ.test.only(1)	
	note = 'indent bad after array'
	...
	ex = ''
	   ...
	   + '...b:."boy"\n'
	   + '';
	EZ.test.options({exfn:exfn, ex:ex, note:note})
...
return
	...
	note = 'indent fault with Array in another array'
	...
	EZ.test.options({exfn:exfn, /*ex:ex,*/ note:note})
	EZ.test.run(obj, g.displayOptions)


	//______________________________________________________________________________
	obj = {a:1, b:new Date("03/14/2016 06:00 pm")}
	EZ.test.run(obj, '', opts)	
