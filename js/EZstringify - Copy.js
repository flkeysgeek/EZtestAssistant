...
ARGUMENTS:		same as JSON.stringify plus . . .
	...
	replacer	(Function) same as native JSON.stringify()
				...
				(Object) One or more EZ.stringify() json format options provided as key/value
					of the following EZ.stringify() options as described below:
 ...
 *	
 */
EZ.json.unquoteKeys.test = function()
{	
	var arr, ctx, arg, args, o, obj, note='', ex, exfn, notefn, fn, val, rtnValue;
	/*  jshint: avoid unused variable error  */	
		e = [arr, ctx, arg, args, o, obj, note='', ex, exfn, notefn, fn, val, , rtnValue];
	// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
	...
	obj = {
        ok: true,
        testno: 1,
        id: "arg1=ctxEZ,arg2=obj",
        note: "<b>issues found during usage</b>\n1st argument is null",
        actual: {
            0: ".EZ",
            1: null,
            2: "1st argument is null",
            results: "1st argument is null"
        },
        expected: {
            results: "1st argument is null"
        },
        saveDateTime: "05-31-2016 07:10:21 pm",
        used: true
    }		
	arg = JSON.stringify(obj,0,4);
	ex = [arg];
	ex.results = "supplied object variable is null"
	ex.ctx = ctx;
	
	EZ.test.options( {ex:'', note:note} )
	EZ.test.run( arg )
	// . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
	EZ.test.run('bad')
}
