EZ.test.savedResults=		//Saved @ 12-09-2016 04:47:10 am
[
	'"test #1 no data"'
,
	'"test #2 no data"'
...
,
	...
	+ '        ],\n'
	+ '        1: {\n'
	+ '            deleted_values: "$.0: more=abc\\n$.1: more=xyz, colors: 0=red, 1=blue",\n'
	+ '            EZequals_options: [\n'
	+ '                {\n'
	+ '                    showDiff: 10,\n'
	+ '                    html: true,\n'
	...
	+ '        results: "[\\n    [\\n        8\\n    ],\\n    [\\n        9\\n    ]\\n]"\n'
	+ '    },\n'
	+ '    saveDateTime: "12-09-2016 04:47:02 am"\n'
	+ '}'
,
	'"test #61 no data"'
,
	...
	+ '        },\n'
	+ '        1: {\n'
	+ '            deleted_values: "$.actual.0: more=abc\\n$.actual.1: more=xyz, colors: 0=red, 1=blue",\n'
	+ '            EZequals_options: [\n'
	+ '                {\n'
	+ '                    showDiff: 10,\n'
	+ '                    html: true,\n'
	...
	+ '        results: "{\\n    \\"actual\\": [\\n        [\\n            8\\n        ],\\n        [\\n            9\\n        ]\\n    ]\\n}"\n'
	+ '    },\n'
	+ '    saveDateTime: "12-09-2016 04:47:09 am"\n'
	+ '}'
,
	'"test #63 no data"'
,
