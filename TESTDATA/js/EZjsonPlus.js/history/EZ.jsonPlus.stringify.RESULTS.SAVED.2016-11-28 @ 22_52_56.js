EZ.test.savedResults=		//Saved @ 11-28-2016 10:52:56 pm
[
	'"test #1 no data"'
,
	'"test #2 no data"'
...
,
	...
	+ '            ]\n'
	+ '        },\n'
	+ '        results: "{\\n    a: \\"abc\\",\\n    b: {\\n        \\"@JSON_escapeMarker@\\": \\"$.b=$.b=$\\"\\n    }\\n}"\n'
	+ '    },\n'
	+ '    expected: {\n'
	+ '        0: {\n'
	+ '            a: "abc",\n'
	+ '            b: {\n'
	+ '                "@JSON_escapeMarker@": "$.expected.0.b=$.expected.0.b=$.expected.0"\n'
	+ '            }\n'
	+ '        },\n'
	+ '        1: {\n'
	+ '            escaped_values: [\n'
	...
	+ '        results: "{\\n    a: \\"abc\\",\\n    b: {\\n        \\"@JSON_escapeMarker@\\": \\"$.b=$.b=$\\"\\n    }\\n}"\n'
	+ '    },\n'
	+ '    saveDateTime: "11-28-2016 10:52:42 pm"\n'
	+ '}'
,
	'"test #8 no data"'
,
